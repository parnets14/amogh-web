...
export default function MedicalProductCarousel() {
  ...
  const nextSlide = useCallback(() => {
    setCurrentSlide((prev) => (prev >= medicalProducts.length - slidesToShow ? 0 : prev + 1))
  }, [medicalProducts.length, slidesToShow])

  const prevSlide = useCallback(() => {
    setCurrentSlide((prev) => (prev <= 0 ? medicalProducts.length - slidesToShow : prev - 1))
  }, [medicalProducts.length, slidesToShow])
                    ...
                    <div className="mb-2 sm:mb-3 space-y-1 text-xs sm:text-sm text-gray-600 hidden sm:block">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <span>{product.model || "Not specified"}</span>
                        </div>
                      </div>
                    </div>
