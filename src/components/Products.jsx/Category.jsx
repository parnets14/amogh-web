              ...
              >
                <div className="relative h-full rounded-xl md:rounded-2xl overflow-hidden shadow-lg md:shadow-xl">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 text-white">
                    ...
                    >
                      {medicalCategories[activeIndex].name} Equipment
                    </motion.h3>
                    <motion.p 
                    ...
                    >
                      {medicalCategories[activeIndex].products}+ advanced devices for precise diagnostics
                    </motion.p>
                    <motion.div
                      initial={{ y: 20 }}
                      animate={{ y: 0 }}
                    ...
                    >
                      <Link
                        to={`/products?category=${medicalCategories[activeIndex].name}`}
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start">
                  <div className={`p-2 md:p-3 rounded-lg bg-gradient-to-r ${medicalCategories[activeIndex].color} mr-3 md:mr-4`}>
