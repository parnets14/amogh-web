...
import { getContactInfo, getMapEmbed, submitMessage } from './contactService';
...
const ContactPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [contactRes, mapRes] = await Promise.all([
          getContactInfo(),
          getMapEmbed()
        ]);
        
        if (contactRes.data) setContactData(contactRes.data);
        if (mapRes.data?.embedUrl) setMapUrl(mapRes.data.embedUrl);
      } catch (err) {
  ...
  const contactMethods = [
    {
      icon: <FaMapMarkerAlt className="text-3xl" />,
      title: "Address",
      content: contactData?.address || "123 Business Street, City, State 12345, Country",
      color: "text-red-500",
      link: "https://maps.google.com"
    },
    {
      icon: <FaPhoneAlt className="text-3xl" />,
      title: "Phone",
      content: contactData?.phone || "+1 (123) 456-7890\n+1 (987) 654-3210",
      color: "text-blue-500",
      link: `tel:${contactData?.phone?.split('\n')[0]?.trim() || '+11234567890'}`
    },
    {
      icon: <FaEnvelope className="text-3xl" />,
      title: "Email",
      content: contactData?.email || "info@yourcompany.com\nsupport@yourcompany.com",
      color: "text-green-500",
      link: `mailto:${contactData?.email?.split('\n')[0]?.trim() || 'info@yourcompany.com'}`
    },
    {
      icon: <FaClock className="text-3xl" />,
      title: "Business Hours",
      content: contactData?.businessHours || "Mon-Fri: 9am - 5pm\nSat: 10am - 2pm\nSun: Closed",
      color: "text-amber-500"
    },
    {
      icon: <FaWhatsapp className="text-3xl" />,
      title: "WhatsApp",
      content: contactData?.whatsappNumber || "+1 (123) 456-7890",
      color: "text-emerald-500",
      link: `https://wa.me/${contactData?.whatsappNumber?.replace(/\D/g, '') || '11234567890'}`
    }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-6 pb-20">
        ...
        >
          ...
          <div className="relative aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-xl">
            <iframe
              src={mapUrl || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215573291234!2d-73.98784492416406!3d40.74844047138999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1687893123456!5m2!1sen!2sus"}
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
